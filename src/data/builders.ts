export const buildersPage = {
	seo: {
		title: 'Feng Shui & Vastu Floor Plan Consulting for Builders',
		description:
			'Custom home floor plan review and builder floor plan consulting from an experienced Feng Shui and Vastu floor plan consultant. Practical Feng Shui for builders and balanced home design before construction begins.',
	},
	hero: {
		...
		cards: [
			{
				...
				description:
					'Get guidance on room placement, entry flow, bedroom positioning, kitchen location, and key living areas while changes are still easy to make.',
			},
			{
				title: 'Feng Shui & Vastu Alignment',
				description:
					'Incorporate ancient design principles in a practical, builder-friendly way that supports balance, comfort, and livability.',
			},
			{
				title: 'Better Buyer Appeal',
				description:
					'Homes that feel good often sell better. A balanced layout can become a meaningful point of difference for buyers who value wellness, culture, and intentional design.',
			},
			{
		...
		items: [
			{
				...
				description:
					'Review the proposed layout before construction begins and identify opportunities for better room positioning, traffic flow, and energy balance.',
			},
			{
				title: 'Entry & Directional Layout Guidance',
				description:
					'Evaluate the home\'s facing direction, main entry, garage access, and primary movement paths through Feng Shui and Vastu principles.',
			},
			{
				title: 'Room Placement Consulting',
				description:
					'Provide guidance on ideal placement for the primary suite, kitchen, family room, dining area, kids rooms, study/prayer space, and other important rooms.',
			},
			{
				title: 'Element Balance Recommendations',
				description:
					'Use the five-element concept to support harmony through layout, materials, colors, and room function.',
			},
			{
				title: 'Builder Collaboration',
				description:
					'Work alongside the builder, architect, designer, or client to offer suggestions that fit the project without overcomplicating the build.',
			},
		],
	},
	process: {
		h2: 'A Simple Process for Builders',
		steps: [
			{
				title: 'Share the Plans',
				description:
			...
			},
			{
				...
				description:
					'Get clear recommendations on what is working well, what may need adjustment, and where small changes could improve the home\'s balance.',
			},
			{
				title: 'Build With More Confidence',
				description:
					'Move forward knowing the home has been reviewed not just for beauty and function, but for harmony and intentional living.',
			},
		],
	},
	benefits: {
		h2: 'Why Add Feng Shui & Vastu Consulting to Your Builds?',
		items: [
			'Create a unique selling point for custom and luxury homes',
			'Appeal to buyers who value wellness, culture, and intentional living',
			'Reduce layout concerns before construction begins',
			'Help clients feel more confident in their floor plan decisions',
			'Add depth and meaning to the design process',
			'Differentiate your homes from standard builder layouts',
		],
	},
	specialty: {
